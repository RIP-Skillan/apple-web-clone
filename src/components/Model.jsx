...
const Model = () => {
  ...
  //roatation
  const [smallrotation, setsmallroatation] = useState(0);
        ...
        <div className='flex flex-col items-center mt-5'>
          <div className='w-full h-[75vh] md:h-[90vh] overflow-hidden relative'>
            <ModelView
              ...
              setRotationState={setsmallroatation}
              item={model}
              size={size}
            />
            ...
            <div className='flex-center'>
              ...
              <button className='size-btn-container'>
                {sizes.map(({label,value}) => (
                  <span key={label} 
                    className='size-btn' 
                    style={{backgroundColor: size === value? 'white': 'black', color: size === value? 'black': 'white'}}
